...
class MedicineView(APIView):
    ...
    def post(self, request):
        ...
        return Response({"success": "Medicine '{}' created successfully".format(medicine_saved.title)})
    ...
    def put(self, request, pk):
        ...
        if serializer.is_valid(raise_exception=True):
            medicine_saved = serializer.save()
        return Response({"success": "Medicine '{}' updated successfully".format(medicine_saved.title)})
...
class UserView(APIView):
    ...
    def put(self, request, pk):
        ...
        if serializer.is_valid(raise_exception=True):
            user_saved = serializer.save()
        return Response({"success": "User '{}' updated successfully".format(user_saved.title)})
...
class OrderView(APIView):
    ...
    def put(self, request, pk):
        ...
        if serializer.is_valid(raise_exception=True):
            order_saved = serializer.save()
        return Response({"success": "Order '{}' updated successfully".format(order_saved.title)})
